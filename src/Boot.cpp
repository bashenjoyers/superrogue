...
// TODO
Boot::Boot() : gm( std::make_shared<GameModel::GameManager>(GameModel::Map::MapOptions {
    .height = 20,
    .width = 100
...
void Boot::play() {
    ...
    std::unique_ptr<Controller::EventProvider> provider = std::make_unique<Controller::EventProvider>(cursor, map);
...
void Boot::firstFrameRender() {
    ...
    renderFactory.getInventoryRenderer()->handleEvent(0, GameModel::ItemType::HELMET);
