...
void CursesInventoryRenderer::renderPotion(GameModel::Potion p, size_t row, bool selected) {
...
void CursesInventoryRenderer::renderItem(std::optional<GameModel::Item> item, GameModel::ItemType type, bool selected) {
