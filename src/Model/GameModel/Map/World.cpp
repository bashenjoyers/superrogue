...
//
//
//bool World::punch_step(const CharacterWithPosition &character1_with_position,
...
//  auto person2 = std::dynamic_pointer_cast<Person>(character2_with_position
//													   .character);  // only for get characteristics and check is it person
...
//	dodge_chance =
//		max(1 - (float)character1_characteristics.dexterity / character2_characteristics.dexterity, dodge_chance);
//  }
//  if (dodge_gen(Values::generator) > dodge_chance) {
//	if (character2_with_position.character->damaged(character1_characteristics.damage)) { // smb died
//	  if (person2 != nullptr) { // Person died
//		map[character2_with_position.pos.x][character2_with_position.pos.y] =
//			get_cell_type(character2_with_position.pos);
//		game_status = GameStatus::END;
...
//	dodge_chance =
//		max(1 - (float)character2_characteristics.dexterity / character1_characteristics.dexterity, dodge_chance);
//  }
//  if (dodge_gen(Values::generator) > dodge_chance) {
//	if (character1_with_position.character->damaged(character2_characteristics.damage)) { // smb died
//	  if (person1 != nullptr) { // Person died
//		map[character1_with_position.pos.x][character1_with_position.pos.y] =
//			get_cell_type(character1_with_position.pos);
//		game_status = GameStatus::END;
//	  } else {  // not drop anything
//		map[character1_with_position.pos.x][character1_with_position.pos.y] =
//			get_cell_type(character1_with_position.pos);
...
//	  case ItemType::HELMET:item_before = person->inventory.get_helmet();
//		person->inventory.set_helmet(item);
//		if (item_before.has_value()) {
//		  auto item_before_value = item_before.value();
//		  items[person_with_position.pos] = std::make_shared<Item>(item_before_value.get_name(),
//																   item_before_value.get_description(),
//																   item_before_value.get_characteristics(),
//																   item_before_value.get_item_type());
//		}
//		break;
//	  case ItemType::ARMOR:item_before = person->inventory.get_armor();
...
//		}
//		break;
//	  case ItemType::BOOTS:item_before = person->inventory.get_boots();
...
//		}
//		break;
//	  case ItemType::WEAPON_MELEE:item_before = person->inventory.get_weapon_melee();
...
//		}
//		break;
//	  case ItemType::WEAPON_DISTANT:item_before = person->inventory.get_weapon_distant();
...
//	correct = true;
//	break;
//  case CharacterAction::CHANGE_WEAPON:correct = person->change_weapon();
//	break;
//  case CharacterAction::CHANGE_ITEM:break;
//  case CharacterAction::WAIT:correct = true;
//	break;
//  default:
...
//	correct = true;
//	break;
//  case CharacterAction::POTION_1:break;
//  case CharacterAction::POTION_2:break;
//  case CharacterAction::POTION_3:break;
//  case CharacterAction::POTION_4:break;
//  case CharacterAction::POTION_5:break;
//  case CharacterAction::CHANGE_WEAPON:break;
//  case CharacterAction::CHANGE_ITEM:break;
//  case CharacterAction::WAIT:correct = true;
//	break;
//  default:
