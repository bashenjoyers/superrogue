...
static superrogue::game_object::item::Item get_item(StuffType stuff_type,
                                                    int characteristics_k) {
  switch (stuff_type) {
  case StuffType::HELM:
    return superrogue::game_object::item::Item(
        "helm", "good old hauberk",
        Characteristics(0, 3, 0, -1, 0) * characteristics_k,
        superrogue::game_object::item::ItemType::HELMET);
  case StuffType::CAP:
    return superrogue::game_object::item::Item(
        "cap", "good old cap",
  ...
  case StuffType::HAUBERK:
    return superrogue::game_object::item::Item(
        ...
        Characteristics(0, 3, 0, -1, 0) * characteristics_k,
        superrogue::game_object::item::ItemType::ARMOR);
  ...
  case StuffType::SNEAKERS:
    return superrogue::game_object::item::Item(
        ...
        Characteristics(0, 0, 0, 2, 0) * characteristics_k,
        superrogue::game_object::item::ItemType::BOOTS);
  ...
  case StuffType::SWORD:
    return superrogue::game_object::item::Item(
        ...
        superrogue::game_object::item::ItemType::WEAPON_MELEE);
  ...
  case StuffType::PISTOL:
    return superrogue::game_object::item::Item(
        ...
        Characteristics(2, 0, 0, 0, 0) * characteristics_k,
        superrogue::game_object::item::ItemType::WEAPON_DISTANT);
  case StuffType::GUN:
    return superrogue::game_object::item::Item(
        "gun", "good old gun",
        Characteristics(3, -1, 0, 0, 0) * characteristics_k,
...
static superrogue::game_object::item::Potion get_potion(PotionType potion_type,
                                                        int characteristics_k) {
  switch (potion_type) {
  case PotionType::DAMAGE_POTION:
    return superrogue::game_object::item::Potion(
...
static superrogue::game_object::character::IEnemyClass
get_enemy_class(superrogue::abstract::EnemyClass enemy_class,
                superrogue::game_object::character::EnemySettings settings) {
  switch (enemy_class) {
  case superrogue::abstract::EnemyClass::AGRESSIVE:
    return superrogue::game_object::character::Agressive(
...
static superrogue::game_object::character::IPersonClass
get_person_class(superrogue::abstract::PersonClass person_class,
                 superrogue::game_object::character::PersonSettings settings) {
  switch (person_class) {
  case superrogue::abstract::PersonClass::ALCHEMIST:
    return superrogue::game_object::character::Alchemist(
        "A novice alchemist (can have up to 7 potions)", settings);
  case superrogue::abstract::PersonClass::FARSIGHTED:
    return superrogue::game_object::character::Farsighted(
        "Can see far away (the field of view is 2 times larger than the "
        "standard one)",
        settings);
  case superrogue::abstract::PersonClass::LUCKY:
    return superrogue::game_object::character::Lucky(
        "Just lucky person (has luck >= 0.9)", settings);
  case superrogue::abstract::PersonClass::SECRETIVE:
    return superrogue::game_object::character::Secretive(
  ...
  case superrogue::abstract::PersonClass::WISE:
    return superrogue::game_object::character::Wise(
