...
struct Generator {
    ...
    uniform_int_gen person_class_i_gen = std::bind(std::uniform_int_distribution<int>(0, superrogue::values::enemy_classes.size()), std::mt19937(rand_seed));
    uniform_int_gen enemy_class_i_gen = std::bind(std::uniform_int_distribution<int>(0, superrogue::values::person_classes.size()), std::mt19937(rand_seed));
    uniform_int_gen firstname_i_gen = std::bind(std::uniform_int_distribution<int>(0, superrogue::values::firstnames.size()), std::mt19937(rand_seed));
    uniform_int_gen lastname_i_gen = std::bind(std::uniform_int_distribution<int>(0, superrogue::values::lastnames.size()), std::mt19937(rand_seed));
...
class GameManager {
    ...
    std::vector<superrogue::game_object::character::Enemy> generate_enemies(GameOptions game_options) noexcept;
