...
static std::uniform_int_distribution<int>
    person_class_i_gen(0, superrogue::values::person_classes.size() - 1);
static std::uniform_int_distribution<int>
    enemy_class_i_gen(0, superrogue::values::enemy_classes.size() - 1);
static std::uniform_int_distribution<int>
    firstname_i_gen(0, superrogue::values::firstnames.size() - 1);
static std::uniform_int_distribution<int>
    lastname_i_gen(0, superrogue::values::lastnames.size() - 1);
