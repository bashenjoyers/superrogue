...
Traveler::Traveler(string description, EnemySettings settings) noexcept : IEnemyClass(description, settings) {}
...
CharacterAction Traveler::strategy(vector<MapEntityWithPosition>& cells, Position& pos) noexcept {
