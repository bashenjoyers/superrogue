...
IEnemy::IEnemy(string name, Characteristics characteristics, IEnemyClass enemy_class) :
    ICharacter(name, enemy_class.get_description(), characteristics), enemy_class(enemy_class) {};
