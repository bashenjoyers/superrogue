...
public:
    ...
    Person(std::string name, superrogue::Characteristics characteristics, superrogue::game_object::character::IPersonClass person_class, superrogue::inventory::Inventory inventory = superrogue::inventory::Inventory(DEFAULT_POTIONS_MAX));
