...
bool Person::is_weapon_melee() const noexcept {
    return weapon_melee;
}

void Person::take_item() const noexcept {}

Characteristics Person::get_full_characteristics() const noexcept {    // FIXME(do it adequately)
...
Person::Person(string name, Characteristics characteristics, IPersonClass person_class, Inventory inventory) :
